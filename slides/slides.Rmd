...
```{r, engine = 'bash', eval = FALSE}
# clone
git clone https://mrmay@bitbucket.org/mrmay/CHPC_workflow.git
...
```{r, engine = 'bash', eval = FALSE}
rsync -a data/big_data.zip mrmay@dtn.brc.berkeley.edu:/global/scratch/users/mrmay/CHPC_workflow/data
```
...
```{r, engine = 'bash', eval = FALSE}
#!/bin/bash
#SBATCH --partition=CHPC
#SBATCH --account=fc_rothfelslab
#SBATCH --qos=CHPC_normal
...
old_dir=$(pwd)
cd /global/scratch/users/$USER/CHPC_workflow/simple/
